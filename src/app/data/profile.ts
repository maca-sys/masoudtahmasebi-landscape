...
export const SOCIAL_LINKS: SocialLink[] = [
  ...
  { label: 'Email', href: 'mailto:mtahmasebi118@gmail.com', icon: 'email' },
];
...
export const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    skills: [
      'TypeScript', 'JavaScript', 'React/Next.js', 'Angular', 'Vue/Nuxt',
      'Node.js (Express, Fastify)', 'C#/.NET', 'PHP/Symfony', 'Shopware 6',
      'Java/Spring', 'React Native/Ionic',
    ],
  },
  {
    title: 'Data & Caching',
    skills: [
      ...
      'OpenSearch/Elasticsearch', 'Oracle', 'MS SQL',
    ],
  },
  {
    title: 'DevOps & Cloud',
    skills: [
      'Docker', 'Kubernetes', 'Terraform', 'AWS', 'Azure (AZ-900 certified)',
      'GitLab CI', 'GitHub Actions', 'Linux administration', 'Sentry',
    ],
  },
  {
    title: 'Architecture & Quality',
    skills: [
      'REST API design', 'Distributed systems', 'Event-driven / message-queue architectures',
      'OWASP secure coding', 'GDPR-aware engineering',
      'AI-assisted development (Claude Code, Cursor, Codex)', 'Unit & integration testing',
    ],
  },
  {
    title: 'Leadership',
    skills: [
      'Agile Scrum/Kanban', 'Sprint planning', 'Roadmapping', 'Release management',
